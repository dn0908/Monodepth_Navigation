...
if __name__ == '__main__':
    ...
    ap.add_argument("-d", "--dir", help="Path to folder containing checkerboard images for calibration", default="/pictures")
    ap.add_argument("-w", "--width", type=int, help="Width of checkerboard (default=10)",  default=10)
